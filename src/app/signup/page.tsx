...
export default function SignupPage() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Start building your business today. No credit card required."
    >
      {/* Social Logins */}
      ...
      <p className="mt-10 text-center text-sm font-medium text-foreground/60">
        ...
        <Link href="/login" className="text-foreground hover:underline underline-offset-4 font-bold">
          Sign in
        </Link>
      </p>
    </AuthLayout>
