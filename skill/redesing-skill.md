...
- Background Mode: full-bleed visual with tonal overlay, soft radial vignette + product, micro-noise gradient
...
- Background Mode: vary boldly (full-bleed visual, color-blocked diptych, duotone)
...
6. Massive visual-first frontend Hero with restrained text
...
- full-bleed visual background with tonal overlay (text remains highly readable)
...
Every generated frontend section must clearly communicate:
- layout
- section hierarchy
- spacing
- typography scale
...
- Centered statement over full-bleed visual (text in lower 40%)
- Bottom-left text over background image
...
## 7. visual-first frontend ART DIRECTION
...
When using full-bleed visual backgrounds:
...
- Background Mode: full-bleed visual with dark tonal overlay
...
- Background Mode mix: solid surface, full-bleed visual background once, editorial side-image at use cases
...
- multiple Background Modes (full-bleed visual at hero + showcase, editorial side-image at case studies, solid + accent for process)
